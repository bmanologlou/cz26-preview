...
<style>
  ...
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .article-hero {{ padding: 120px 48px 40px; max-width: 1440px; margin: 0 auto; }}
  ...
  .article-image {{ max-width: 1440px; margin: 0 auto; padding: 0 48px 48px; }}
  .article-image img {{ width: 100%; height: auto; display: block; }}

  .article-body {{ max-width: 1440px; margin: 0; padding: 0 48px 48px; }}
  .article-body p {{ font-size: 17px; line-height: 1.75; color: rgba(245,243,239,.8); margin-bottom: 24px; max-width: 860px; }}

  .article-event-info {{ max-width: 1440px; margin: 0; padding: 0 48px 48px; }}
  .event-card {{ border: 1px solid rgba(255,255,255,.1); padding: 24px 32px; display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 24px; max-width: 860px; }}
  ...
  .article-back {{ max-width: 1440px; margin: 0; padding: 0 48px 80px; }}
