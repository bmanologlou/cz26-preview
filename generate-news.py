...
<style>
  ...
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .article-body {{ max-width: 720px; margin: 0 auto; padding: 0 48px 48px; }}
  .article-body p {{ font-size: 17px; line-height: 1.75; color: rgba(245,243,239,.8); margin-bottom: 24px; }}

  .article-event-info {{ max-width: 720px; margin: 0 auto; padding: 0 48px 48px; }}
  ...
  .article-back {{ max-width: 720px; margin: 0 auto; padding: 0 48px 80px; }}
